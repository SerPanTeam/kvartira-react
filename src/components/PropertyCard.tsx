...
//import { FaViber } from "react-icons/fa"; // Импортируем иконку Viber
    ...
    <Card
      sx={{
        ...
        "&:hover": {
          ...
          boxShadow: 6, // Добавление тени при наведении
        },
      }}
    >
      ...
      <Grid container spacing={1} sx={{ mt: 2, px: 2, pb: 2 }}>
        {[
          {
            color: "#665CAC", //"secondary",
            href: `viber://chat?number=%2B${phoneNumber}`,
            icon: ViberIcon,
            label: "Viber",
          },
          {
            color: "#25D366", //"success",
          ...
          <Grid item xs={4} key={index}>
            <Button
              variant="contained"
              //color={
              //messenger.color as "primary" | "secondary" | "success" | "info"
              //}
              ...
              sx={{
                ...
                "&:hover": {
                  backgroundColor: messenger.color, // Сохраняем основной цвет при наведении
